...
class Car extends Factory {
  constructor(model,doors,color,enginetype,transmission,trim,wheelstrim,audio,seatstrim,moonroof,warranty,massBuild) {
...
class Truck extends Factory {
  constructor(model, color, enginesize, hitch, bed, navigation, trim, warranty) {
    super(trim, warranty);
    this.model = model;
    this.color = color;
...
const trailBlazer = new Truck('Trail Blazer', 'Blue', 8, true, 'Standard', true, 'Sport');
